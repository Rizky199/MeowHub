...
-- Shortcut Referensi
-- =====================
local Config    = _G.TVG.Config
local State     = _G.TVG.State
local Utils     = _G.TVG.Utils
local GUI       = _G.TVG.GUI
local Soul      = _G.TVG.Soul
local Lobby     = _G.TVG.Actions.Lobby
local Steril    = _G.TVG.Actions.Sterilization
local Autopsy   = _G.TVG.Actions.Autopsy
local Morgue    = _G.TVG.Actions.Morgue
local Cremation = _G.TVG.Actions.Cremation

-- Update awal
GUI.TaskText.Text = Utils.GetTaskText()
Soul.CheckSoul()
